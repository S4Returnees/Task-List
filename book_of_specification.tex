...
\pagestyle{fancy}
\fancyhead[L]{Book of Specification : \textit{Graphical User Interface}}
%\fancyfoot[L]{TriOCR}
\fancyfoot[C]{
...
\textbf{\textit{Graphical User Interface}}}
\date{May 2026}
\author{
...
The project will be developed using the Rust programming language, ensuring full compatibility and a consistent experience across both Windows and Linux environments. The development process will rely on Cargo for efficient dependency management and automated build procedures.
